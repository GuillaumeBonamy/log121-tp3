...
/**
 * Classe du patron Commande représentant le receveur pour les commandes de
...
public class Receveur {
	...
	/**
	 * Méthode qui exécute une translation verticale sur une image. Elle reçoit
	 * en paramètre les 4 nouvelles coordonées souhaitées de l'image.
	 * 
	 * @param x1
	 ...
	 * @param y2
	 *            Valeur Y du deuxième point de l'image
	 */
	...
	/**
	 * Méthode qui exécute un zoom sur une image. Elle reçoit en paramètre les 4
	 * coordonnées souhaitées de l'image.
	 * 
	 * @param x1
	 ...
	 * @param x2
	 *            Valeur X pour le deuxième point de l'image
	 * @param y2
	 *            Valeur Y pour le deuxième point de l'image
	 */
	...
	/**
	 * Méthode qui effectue la translation sur les X. Elle reçoit en paramètre
	 * les coordonées X souhaitées de l'image
	 * 
	 * @param x1
	 *            Valeur X pour le premier point de l'image
	 * @param x2
	...
	/**
	 * Méthode qui exécute une translation sur les valeurs Y. Elle reçoit en
	 * paramètre les coordonnées Y souhaitées de l'image.
	 * 
	 * @param y1
	 *            Valeur Y du premier point de l'image
	 * @param y2
	...
	/**
	 * Méthode qui effectue un zoom sur les coordonées X des 2 points de
	 * l'image. Elle recoit en paramètre les coordonnées X souhaitées de
	 * l'image.
	 * 
	 * @param x1
	 *            Coordonnée X du premier point de l'image
	 * @param x2
	 *            Coordonnée X du deuxième point de l'image
	 */
	...
	/**
	 * Méthode qui effectue un zoom sur les coordonnées Y des 2 points de
	 * l'image. Elle reçoit en paramètre les coordonnées Y souhaitées de
	 * l'image.
	 * 
	 * @param y1
	 *            Coordonnée Y du premier point de l'image
	 * @param y2
	 *            Coordonnée Y du deuxième point de l'image
	 */
	...
	/**
	 * Méthode qui vérifit les bornes X pour le premier point de l'image Elle
	 * reçoit en paramètre la borne x1 de l'image.
	 * 
	 * @param x1
	 *            Valeur X du premier point de l'image
	...
	/**
	 * Méthode qui vérifit les bornes X pour le deuxième point de l'image Elle
	 * reçoit en paramètre la borne x2 de l'image.
	 * 
	 * @param x2
	 *            Valeur X du deuxième point de l'image
	...
	/**
	 * Méthode qui vérifit les bornes Y du premier point de l'image Elle reçoit
	 * en paramètre la borne Y1 de l'image
	 * 
	 * @param y1
	...
	/**
	 * Méthode qui vérifit si les bornes Y du deuxième point de l'image sont
	 * valides Elle reçoit en paramètre la borne y2 de l'image
	 * 
	 * @param y2
	 * @return Si les bornes sont valides ou non
	 */
	...
	/**
	 * Méthode qui créer l'image initiale sélectionnée par l'utilisateur Elle
	 * reçoit en paramètre le chemin d'accès de l'image et les 2 dimensions
